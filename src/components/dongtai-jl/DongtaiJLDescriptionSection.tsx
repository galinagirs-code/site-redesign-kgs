          ...
          <Card className="border-none shadow-lg mb-6">
            <CardContent className="p-6 md:p-8">
              ...
              <p className="text-base md:text-lg text-primary leading-relaxed">
                Установки серии JL отличаются надёжной конструкцией, высокой производительностью и оптимальным соотношением цены и эффективности, что делает их востребованными для городских и инфраструктурных проектов.
              </p>
            </CardContent>
          </Card>
