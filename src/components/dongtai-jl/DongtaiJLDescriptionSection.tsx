          ...
          <Card className="border-none shadow-lg mb-6">
            <CardContent className="p-4 md:p-6">
              <p className="text-base md:text-lg text-primary leading-relaxed">
                Горизонтально-направленные буровые установки Dongtai JuLi (серия JL) — это надёжное и эффективное решение для выполнения задач горизонтально-направленного бурения, особенно в условиях городской застройки и ограниченного пространства.
              </p>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Интегрированная компоновка обеспечивает удобство транспортировки и эффективную работу на объектах с плотной застройкой",
                  ].map((item, i) => (
