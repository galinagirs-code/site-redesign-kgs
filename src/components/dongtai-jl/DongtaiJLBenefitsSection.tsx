...
const benefits = [
  ...
  },
  {
    ...
    description: "Интегрированная компоновка узлов обеспечивает удобство транспортировки и эффективную работу на объектах с плотной застройкой.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-heading font-bold text-primary mb-8 text-center">
            Преимущества горизонтально-направленных буровых установок JuLi (серия JL)
          </h2>
