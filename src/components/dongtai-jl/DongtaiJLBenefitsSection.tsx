...
const benefits = [
  ...
  {
    icon: "MapPin",
    title: "Работа в городских условиях",
    description: "Интегрированная компоновка узлов для компактности и удобства транспортировки. Идеально для работы в условиях плотной застройки.",
  },
];
