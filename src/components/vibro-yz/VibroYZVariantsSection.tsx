...
const models = [
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-80DCX2" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-120DCX2" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-160DCX2" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Габариты (мм)", value: "3855×705×2035" },
      { label: "Вес (кг)", value: "9600" },
      { label: "Зажим для трубы", value: "YZJ-200DCX2" },
      { label: "Зажим для шпунта", value: "YZJ-320" },
      { label: "Гидравлическая станция", value: "1200P" },
    ],
  },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-160DCX4" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-200DCX4" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-320DCX4" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-320DCX8" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-200DCX8" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-160DCX36" },
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Зажим для трубы", value: "YZJ-320DCX16" },
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-primary/70 mb-8">
            Нажмите на карточку, чтобы увидеть полные характеристики
          </p>
