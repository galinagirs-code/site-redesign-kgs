...
const benefits = [
  ...
  },
  {
    ...
    description: "Расширяемая гусеничная база и низкий центр тяжести обеспечивают стабильную работу на сложных грунтах.",
  },
  {
    icon: "Truck",
  ...
  },
  {
    icon: "Clock",
    title: "Долговечность",
    description: "Конструкция рассчитана на стабильную работу в тяжёлых условиях строительных площадок.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-heading font-bold text-primary mb-8 text-center">
            Ключевые преимущества STARKE LH
          </h2>
