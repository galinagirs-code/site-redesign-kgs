        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-primary mb-6 text-center">
              КБУРГ — копрово-бурильная установка нового поколения
            </h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-6">
              <div>
                <p className="text-base md:text-lg text-primary leading-relaxed mb-4">
                  КБУРГ — это первая отечественная разработка, обеспечивающая совместное использование сваебойного и бурильного оборудования на одной копровой мачте.
                </p>
                <p className="text-base md:text-lg text-primary leading-relaxed mb-6">
                  Установка представляет собой уникальное навесное оборудование, которое позволяет эффективно расширить функциональность базовой техники без необходимости покупки специализированной машины.
                </p>
                <div className="space-y-3">
                  {[
                    "Первая отечественная разработка с совмещением сваебойных и бурильных функций",
                    "Универсальная установка на экскаваторы различных производителей от 18 тонн",
                    "Расширение возможностей базовой техники без покупки специализированной машины",
