          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-6">
              <div>
                ...
                <p className="text-base md:text-lg text-primary leading-relaxed mb-4">
                  Установка позволяет расширить функциональность базовой техники без покупки специализированной машины. Копрово-бурильная установка осуществляет погружение (забивку) железобетонных или металлических свай длиной до 16 метров с максимальным сечением 400×400 мм, а также устройство скважин строительного назначения и шпунтовые работы.
                </p>
