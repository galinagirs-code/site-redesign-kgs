        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-primary mb-6 text-center">
              Гидравлические буровые установки JINT (серия SH)
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-6">
              <div>
                <p className="text-base md:text-lg text-primary leading-relaxed mb-6">
                  Гидравлические буровые установки JINT серии SH — это надёжное оборудование для устройства свайных фундаментов и выполнения буровых работ. Установки оснащены усиленной конструкцией и современной гидравлической системой, обеспечивающей стабильную работу при бурении на большую глубину.
                </p>
                <p className="text-base md:text-lg text-primary leading-relaxed mb-6">
                  Производитель: Shanghai Jintai Construction Machinery Co., Ltd. — государственная машиностроительная компания Китая, основанная в 1921 году.
                </p>
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-accent font-bold text-base md:text-lg mt-0.5">&#10004;</span>
                    <span className="text-base md:text-lg text-primary">Надёжная работа в сложных условиях</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-accent font-bold text-base md:text-lg mt-0.5">&#10004;</span>
                    <span className="text-base md:text-lg text-primary">Простота эксплуатации</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="text-accent font-bold text-base md:text-lg mt-0.5">&#10004;</span>
                    <span className="text-base md:text-lg text-primary">Универсальность применения</span>
                  </div>
                </div>
              </div>
...
export default JintSHHeroSection;
