...
const benefits = [
  ...
  },
  {
    ...
    description: "Совместимость с навесным оборудованием ведущих мировых брендов и различными типами келли-штанги (телескопической буровой штанги) для задач любой сложности.",
  },
  {
    icon: "Building2",
