            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-6">
              <div>
                <p className="text-base md:text-lg text-primary leading-relaxed mb-6">
                  Серия CS — это гидравлические вибропогружатели с боковым зажимом, устанавливаемые на экскаватор и предназначенные для погружения и извлечения свай, труб и шпунта.
                </p>
                <p className="text-base md:text-lg text-primary leading-relaxed mb-6">
