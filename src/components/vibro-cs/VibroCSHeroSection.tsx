            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-6">
              <div>
                <p className="text-base md:text-lg text-primary leading-relaxed mb-6">
                  Гидравлические экскаваторные вибропогружатели с боковым зажимом (серия CS) — флагманская линейка оборудования, предназначенная для погружения и извлечения свай, труб и шпунтовых профилей, отличающаяся высокой надёжностью и качеством изготовления.
                </p>
                <p className="text-base md:text-lg text-primary leading-relaxed mb-6">
                  Главная особенность — боковой захват сваи, который позволяет работать без необходимости перемещения экскаватора и выполнять монтаж в ограниченных условиях. Оборудование создаёт высокочастотные вибрации, за счёт которых грунт временно разжижается, и свая легко погружается под собственным весом и усилием машины.
                </p>
                <div className="space-y-3">
                  {[
                    "Работа в стеснённых условиях без перемещения экскаватора",
                    "Высокая точность позиционирования сваи",
                    "Работа со сваями длиннее стрелы экскаватора",
                    "Подходит для шпунта, труб, двутавров и ж/б свай",
                  ].map((item) => (
