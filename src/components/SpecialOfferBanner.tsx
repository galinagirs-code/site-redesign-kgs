  ...
  return (
    <section className="py-8 md:py-12 bg-gradient-to-br from-primary via-primary to-primary/90 overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <Card className="bg-white border-2 border-accent/30 shadow-2xl overflow-hidden transition-all duration-300 group-hover:shadow-3xl group-hover:scale-[1.02] cursor-pointer">
            <CardContent className="p-6 md:p-8">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex-1 text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start mb-4">
                    <Button className="btn-gradient text-white font-bold text-base md:text-lg px-6 py-3 shadow-lg group-hover:shadow-xl transition-all pointer-events-none">
                ...
                <div className="w-full md:w-auto">
                  <Button 
                    size="lg" 
                    className="btn-gradient text-white font-bold text-lg w-full md:w-auto shadow-lg group-hover:shadow-xl transition-all pointer-events-none"
                  >
