  ...
  return (
    <section className="py-8 md:py-12 bg-gradient-to-br from-primary via-primary to-primary/90 overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <Card className="bg-white border-2 border-accent/30 shadow-2xl overflow-hidden cursor-pointer hover:border-accent hover:shadow-accent/20 hover:shadow-2xl transition-all duration-300">
