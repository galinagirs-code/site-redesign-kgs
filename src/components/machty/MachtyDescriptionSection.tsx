    ...
    <section id="description" className="py-12 md:py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-heading font-bold text-primary mb-12 text-center">Общая информация</h2>
          ...
          <Card className="border-none shadow-lg mb-6">
            <CardContent className="p-6 md:p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl md:text-3xl font-heading font-bold text-primary">Назначение и возможности</h3>
              </div>
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-6 md:p-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl md:text-3xl font-heading font-bold text-primary">Области применения</h3>
                </div>
                ...
                <p className="text-primary mb-3 text-base md:text-lg">Используется при строительстве фундаментов в отраслях:</p>
                <ul className="list-disc pl-5 space-y-1.5 text-primary text-base md:text-lg">
            ...
            <Card className="border-none shadow-lg">
              <CardContent className="p-6 md:p-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl md:text-3xl font-heading font-bold text-primary">Принцип работы</h3>
                </div>
                <p className="text-primary mb-3 text-base md:text-lg">Копровая мачта МК KGS — металлоконструкция, обеспечивающая:</p>
                <ul className="list-disc pl-5 space-y-1.5 text-primary mb-4 text-base md:text-lg">
                  <li>перемещение сваи и рабочего оборудования</li>
                  <li>точное центрирование по оси</li>
                  <li>наведение сваи на точку погружения</li>
                </ul>
                <p className="text-primary mb-3 text-base md:text-lg">Крепление мачты осуществляется с помощью специальных устройств (цапф) и раскосов.</p>
                <p className="text-primary font-semibold mb-2 text-base md:text-lg">Копровая установка (кран + мачта):</p>
          ...
          <Card className="border-none shadow-lg">
            <CardContent className="p-6 md:p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl md:text-3xl font-heading font-bold text-primary">Управление копровой мачтой</h3>
              </div>
