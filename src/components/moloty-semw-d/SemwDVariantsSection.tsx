...
const variants = [
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "505" },
      ...
      { label: "Подъёмное устройство, кг", value: "100" },
      { label: "Транспортная скоба, кг", value: "11" },
      { label: "Наголовник, кг", value: "15" },
      { label: "Инструмент, кг", value: "75" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "686" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "1 304" },
      ...
      { label: "Подъёмное устройство, кг", value: "180" },
      { label: "Транспортная скоба, кг", value: "20" },
      { label: "Наголовник, кг", value: "23" },
      { label: "Инструмент, кг", value: "100" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "1 695" },
      ...
      { label: "Подъёмное устройство, кг", value: "400" },
      { label: "Транспортная скоба, кг", value: "31,5" },
      { label: "Наголовник, кг", value: "25" },
      { label: "Инструмент, кг", value: "125" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "1 800" },
      ...
      { label: "Подъёмное устройство, кг", value: "400" },
      { label: "Транспортная скоба, кг", value: "72" },
      { label: "Наголовник, кг", value: "34" },
      { label: "Инструмент, кг", value: "125" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "2 600" },
      ...
      { label: "Подъёмное устройство, кг", value: "750" },
      { label: "Транспортная скоба, кг", value: "135" },
      { label: "Наголовник, кг", value: "220" },
      { label: "Инструмент, кг", value: "125" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "3 600" },
      ...
      { label: "Подъёмное устройство, кг", value: "770" },
      { label: "Транспортная скоба, кг", value: "950" },
      { label: "Инструмент, кг", value: "125" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "3 900" },
      { label: "Диаметр каната, мм", value: "Ø32" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "4 500" },
      ...
      { label: "Подъёмное устройство, кг", value: "1 700" },
      { label: "Транспортная скоба, кг", value: "950" },
      { label: "Инструмент, кг", value: "125" },
      ...
      { label: "Мин. высота установки, мм", value: "—" },
      { label: "Шаг направляющих", value: "—" },
    ],
  },
  {
    name: "D180",
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "5 000" },
      { label: "Диаметр каната, мм", value: "Ø37" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "6 200" },
      ...
      { label: "Подъёмное устройство, кг", value: "2 400" },
      { label: "Транспортная скоба, кг", value: "950" },
      { label: "Инструмент, кг", value: "125" },
  ...
  },
  {
    ...
    detailedSpecs: [
      ...
      { label: "Сила удара (давление), кН", value: "7 000" },
      { label: "Диаметр каната, мм", value: "Ø42" },
