...
const variants = [
  {
    name: "S250",
    specs: [
      { label: "Центробежная сила", value: "250 кН" },
    ...
    detailedSpecs: [
      ...
      { label: "Центробежная сила, кН", value: "250" },
  ...
  },
  {
    name: "S350",
    specs: [
      { label: "Центробежная сила", value: "360 кН" },
    ...
    detailedSpecs: [
      ...
      { label: "Центробежная сила, кН", value: "360" },
      { label: "Давление гидросистемы, МПа", value: "32" },
  ...
  },
  {
    name: "S500",
    specs: [
      { label: "Центробежная сила", value: "450 кН" },
    ...
    detailedSpecs: [
      ...
      { label: "Центробежная сила, кН", value: "450" },
      { label: "Давление гидросистемы, МПа", value: "32" },
  ...
  },
  {
    name: "S600",
    specs: [
      { label: "Центробежная сила", value: "600 кН" },
      { label: "Частота вибрации", value: "2800 об/мин" },
    ...
    detailedSpecs: [
      ...
      { label: "Центробежная сила, кН", value: "600" },
      { label: "Давление гидросистемы, МПа", value: "32" },
  ...
  },
  {
    name: "S650",
    specs: [
      { label: "Центробежная сила", value: "650 кН" },
    ...
    detailedSpecs: [
      ...
      { label: "Центробежная сила, кН", value: "650" },
      { label: "Давление гидросистемы, МПа", value: "32" },
  ...
  },
  {
    name: "S800",
    specs: [
      { label: "Центробежная сила", value: "800 кН" },
    ...
    detailedSpecs: [
      ...
      { label: "Центробежная сила, кН", value: "800" },
      { label: "Давление гидросистемы, МПа", value: "32" },
      { label: "Расход гидросистемы, л/мин", value: "310" },
  ...
  },
  {
    name: "S1000",
    specs: [
      { label: "Центробежная сила", value: "1050 кН" },
    ...
    detailedSpecs: [
      ...
      { label: "Центробежная сила, кН", value: "1 050" },
      { label: "Давление гидросистемы, МПа", value: "32" },
  ...
  },
  {
    name: "S1100",
    specs: [
      { label: "Центробежная сила", value: "1100 кН" },
      { label: "Частота вибрации", value: "2300 об/мин" },
      { label: "Подходящий экскаватор", value: "70–90 т" },
    ],
    detailedSpecs: [
      ...
      { label: "Центробежная сила, кН", value: "1 100" },
      { label: "Давление гидросистемы, МПа", value: "32" },
      { label: "Расход гидросистемы, л/мин", value: "380" },
        ...
        <div className="max-w-5xl mx-auto">
          <div className="animate-fade-in">
            <h2 className="text-2xl md:text-3xl font-heading font-bold text-primary mb-8 text-center">
              Модели гидравлических экскаваторных вибропогружателей с нижним зажимом (серия S)
            </h2>
