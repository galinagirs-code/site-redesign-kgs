        ...
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <Card className="border-none shadow-lg">
            <CardContent className="p-6 md:p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl md:text-2xl font-heading font-bold text-primary">Общее описание</h3>
              </div>
              <p className="text-base text-primary leading-relaxed mb-4">
                Мачта МКБЭ-2 — первая отечественная разработка, обеспечивающая совместное использование сваебойного и бурильного оборудования на одной мачте. Конструкция предусматривает два ряда направляющих:
              </p>
              ...
              <p className="text-base text-primary leading-relaxed">
                Подъём и опускание молота и сваи — грузовыми лебёдками. Перемещение гидравлического вращателя — гидроцилиндром с системой полиспастов (усилие 19 тонн). По желанию заказчика — цепной механизм перемещения вращателя.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-none shadow-lg">
            <CardContent className="p-6 md:p-8">
              ...
              <p className="text-base text-primary leading-relaxed mb-4">
                Мачта МКБЭ-2 применяется при строительстве жилых и промышленных зданий, мостов, инфраструктурных сооружений и нефтегазовых объектов. Совместима с российскими и импортными экскаваторами.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <p className="text-base font-semibold text-primary mb-2">Сваебойные работы:</p>
                  <div className="space-y-2">
                    <CheckItem text="Забивка железобетонных свай до 12 м" />
