...
const benefits = [
  ...
  {
    icon: "TrendingUp",
    title: "Мощное усилие растяжения",
    description: "Усилие растяжения 700 тонн обеспечивает эффективное вытягивание двутавровых балок длиной до 32 м.",
  },
  {
    icon: "Gauge",
    title: "Высокая мощность насоса",
    description: "Мощный гидравлический насос обеспечивает стабильное давление и высокую производительность на любом объекте.",
  },
  {
    icon: "RotateCcw",
