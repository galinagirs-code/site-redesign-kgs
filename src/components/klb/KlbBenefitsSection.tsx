...
const benefits = [
  ...
  },
  {
    ...
    description: "Шагающий механизм обеспечивает низкое удельное давление на грунт, позволяя работать на слабых и нестабильных основаниях.",
  },
  {
    icon: "Settings",
    title: "Многофункциональность",
    description: "Возможность установки дизель-молота, гидромолота, вибропогружателя или буровой головки — для задач любой сложности.",
  },
  {
    icon: "Navigation",
  ...
  },
  {
    icon: "Leaf",
    title: "Экологичность",
    description: "Электрическая силовая установка снижает уровень шума и не загрязняет окружающую среду при вспомогательных операциях.",
  },
];
