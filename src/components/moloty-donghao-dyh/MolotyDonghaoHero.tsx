          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="space-y-4">
                ...
                <p className="text-base md:text-lg text-primary leading-relaxed">
                  Линейка из 11 моделей с энергией удара от 24 до 680 кН·м позволяет подобрать решение под задачи любого масштаба. Питание от гидросистемы базовой машины или отдельной гидростанции DongHao.
                </p>
