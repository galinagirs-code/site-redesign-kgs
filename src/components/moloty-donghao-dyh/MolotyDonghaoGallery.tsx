    ...
    <section id="gallery" className="py-10 md:py-14 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center py-16 px-8 border-2 border-dashed border-gray-200 rounded-2xl bg-white text-center">
...
export default MolotyDonghaoGallery;
