        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg mb-8">
            <p className="text-primary/80 leading-relaxed">
              Для гидравлических крановых вибропогружателей (серия YZ-VM) предлагается широкий ассортимент зажимов, предназначенных для шпунтовых свай, Н-балок и других профилей. Надёжная конструкция и мощный зажимной цилиндр обеспечивает стабильную и безопасную фиксацию свай.
            </p>
          </div>
...
export default VibroYZVMClampSection;
