        ...
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            <CardContent className="p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-base text-primary mb-2">В качестве сваепогружателя применяются сваебойные молоты российского и импортного производства:</p>
                  <div className="space-y-2">
          ...
          <Card className="border-none shadow-lg">
            <CardContent className="p-6 md:p-8">
              ...
              <p className="text-base text-primary leading-relaxed mb-3">На мачте установлены:</p>
              <div className="space-y-2 mb-4">
