...
const benefits = [
  ...
  {
    icon: "Construction",
    title: "Производительная лебедка",
  ...
  },
  {
    ...
    description: "Многопоточная гидравлическая система с оптимальным распределением мощности. Сниженное энергопотребление и повышенная эффективность работы.",
  },
  {
