        ...
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="border-none shadow-lg mb-6">
            <CardContent className="p-6 md:p-8">
              ...
              <p className="text-primary mb-4 text-base leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-xl p-5">
                  <h4 className="text-primary font-semibold mb-2 text-base">Виды погружаемых элементов</h4>
                ...
                <div className="bg-gray-50 rounded-xl p-5">
                  <h4 className="text-primary font-semibold mb-2 text-base">Области применения</h4>
                  <ul className="list-disc pl-5 space-y-1.5 text-primary text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <Card className="border-none shadow-lg">
              <CardContent className="p-6 md:p-8">
                ...
                <p className="text-primary mb-3 text-base leading-relaxed">
                ...
                <p className="text-primary mb-3 text-base">В результате происходит:</p>
                ...
                <p className="text-primary mt-3 text-base leading-relaxed">
