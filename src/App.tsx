...
import VibroCS from "./pages/VibroCS";
import VibroYZ from "./pages/VibroYZ";
    ...
    <CartProvider>
      <TooltipProvider>
        ...
        <Routes>
          ...
          <Route path="/catalog/vibro-cs" element={<VibroCS />} />
          <Route path="/catalog/vibro-yz" element={<VibroYZ />} />
