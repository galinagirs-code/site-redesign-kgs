...
import VibroYZVMHeroSection from "@/components/vibro-yz-vm/VibroYZVMHeroSection";
import VibroYZVMVariantsSection from "@/components/vibro-yz-vm/VibroYZVMVariantsSection";
import VibroYZVMBenefitsSection from "@/components/vibro-yz-vm/VibroYZVMBenefitsSection";
import VibroYZVMClampSection from "@/components/vibro-yz-vm/VibroYZVMClampSection";
import VibroYZVMDescriptionSection from "@/components/vibro-yz-vm/VibroYZVMDescriptionSection";
import VibroYZVMGallerySection from "@/components/vibro-yz-vm/VibroYZVMGallerySection";

const YonganYZVM = () => {
  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Гидравлические крановые вибропогружатели Yongan серия YZ-VM",
    "description": "Гидравлические крановые вибропогружатели серии YZ-VM от Yongan Machinery Co., Ltd. для погружения и извлечения шпунтовых свай, трубных свай и Н-балок.",
    "brand": {
      "@type": "Brand",
      "name": "Yongan"
    },
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Вибропогружатели крановые Yongan серия YZ-VM | KGS"
        description="Гидравлические крановые вибропогружатели серии YZ-VM от Yongan. Более 20 моделей. Погружение шпунта, труб, Н-балок. Морские работы."
        keywords="вибропогружатель крановый, Yongan YZ-VM, гидравлический вибропогружатель, серия YZ-VM, шпунт, погружение свай, морские работы"
        canonical="https://kgs-ural.ru/catalog/yongan-yz-vm"
        ogTitle="Гидравлические крановые вибропогружатели Yongan серия YZ-VM"
        ogDescription="Вибропогружатели серии YZ-VM для крановых работ. Компоненты Parker, FAG, Rexroth, Caterpillar."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/yongan-yz-vm" />
            </div>
          </div>
        </div>
      </header>
      ...
      <Breadcrumbs items={[
        ...
        { label: 'Вибропогружатели крановые', path: '/catalog/vibropogružateli-kranovye' },
        { label: 'Серия YZ-VM (Yongan)', path: '/catalog/yongan-yz-vm' }
      ]} />

      <VibroYZVMHeroSection />
      <VibroYZVMVariantsSection />
      <VibroYZVMBenefitsSection />
      <VibroYZVMClampSection />
      <VibroYZVMDescriptionSection />
      <VibroYZVMGallerySection />
