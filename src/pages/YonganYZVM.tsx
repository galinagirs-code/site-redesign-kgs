...
const YonganYZVM = () => {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Вибропогружатели гидравлические крановые Yongan (серия YZ-VM)",
    "description": "Гидравлические вибропогружатели Yongan серии YZ-VM с встроенным зажимом для кранов. Универсальное решение для забивки и извлечения свай.",
    "brand": {
      "@type": "Brand",
      "name": "Yongan"
    },
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title="Вибропогружатели гидравлические крановые Yongan (серия YZ-VM) | KGS"
        description="Гидравлические вибропогружатели Yongan серии YZ-VM с встроенным зажимом. Для забивки и извлечения шпунтовых свай, стальных труб, балок."
        keywords="вибропогружатели, Yongan, серия YZ-VM, гидравлические вибропогружатели, крановые вибропогружатели, встроенный зажим"
        canonical="https://kgs-ural.ru/catalog/yongan-yz-vm"
        ogTitle="Вибропогружатели гидравлические крановые Yongan (серия YZ-VM)"
        ogDescription="Вибропогружатели YZ-VM с зажимом для кранов. Универсальное решение для строительства мостов, дамб, причалов."
      />
        ...
        <div className="container mx-auto px-4 py-8">
          <Breadcrumbs 
            items={[
              ...
              { label: "Вибропогружатели гидравлические крановые Yongan (серия YZ-VM)" }
            ]}
          />
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            <div>
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gray-100 mb-4">
                <OptimizedImage
                  ...
                  alt="Вибропогружатели гидравлические крановые Yongan (серия YZ-VM)"
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold mb-4">Вибропогружатели гидравлические крановые Yongan (серия YZ-VM)</h1>
          ...
          <Card className="mt-12">
            <CardContent className="p-8">
              ...
              <EquipmentForm 
                equipmentType="Вибропогружатели гидравлические крановые Yongan (серия YZ-VM)"
                questions={questions}
              />
            </CardContent>
          </Card>
