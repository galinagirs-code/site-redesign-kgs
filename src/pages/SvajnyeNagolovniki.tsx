...
const SvajnyeNagolovniki = () => {
  const productSchema = {
    ...
    "@type": "Product",
    name: "Свайные наголовники KGS",
    description:
      "Свайные наголовники для защиты оголовка сваи при забивке молотом. Для круглых, квадратных свай, труб, двутавров и шпунта.",
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Свайные наголовники для защиты свай при забивке молотом. Для квадратных, круглых свай, труб, двутавров и шпунта. Подбор и поставка по всей России."
        keywords="свайные наголовники, наголовники для свай, защита свай, забивка свай, сваебойное оборудование"
        canonical="https://kgs-ural.ru/catalog/svajnye-nagolovniki"
        ogTitle="Свайные наголовники KGS — защита сваи при забивке"
        ogDescription="Стальные наголовники с амортизирующими вставками для всех типов свай. Подбор под молот и сечение сваи."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/svajnye-nagolovniki" />
            </div>
          </div>
        </div>
      </header>
      ...
      <Breadcrumbs items={[
        ...
        { label: "Свайные наголовники", path: "/catalog/svajnye-nagolovniki" },
      ]} />
