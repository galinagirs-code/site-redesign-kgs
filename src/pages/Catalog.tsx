      ...
      description: {
        ...
        sections: [
          ...
          },
          {
            ...
            text: "Копровые установки Dongtai Juli серии KLB предназначены для выполнения свайных работ и лидерного бурения. Они могут оснащаться дизель-молотом, гидравлическим молотом, вибропогружателем или буровой установкой (вращатель). Отличаются низким удельным давлением на грунт, высокой устойчивостью и многофункциональностью."
          },
          {
