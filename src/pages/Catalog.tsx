  ...
  const categories = [
      ...
      questions: [
        {
          ...
          options: ["Гидравлический", "Дизельный трубчатый", "Дизельный штанговый"]
        },
        {
          question: "На какую мачту планируете навешивать?"
        },
        {
          question: "Какие сваи планируете забивать?"
        },
        {
          ...
          options: ["Круглые", "Квадратные", "Плоские", "Под штопоры"]
        }
      ]
    },
    {
      ...
      questions: [
        {
          question: "Тип грунтов на объекте?",
          options: ["Песок", "Глина", "Супесь", "Суглинок", "Скальные породы"]
        },
        {
          question: "Какое сечение свай (мм)?"
        }
      ]
    },
    {
      ...
      questions: [
        {
          question: "Диаметр бурения (мм)?"
        },
        {
          question: "Глубина бурения (м)?"
        },
        {
          question: "Грузоподъемность базовой машины (тонн)?"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      questions: [
        {
          question: "На какую базовую машину будете навешивать?",
          options: ["Экскаватор 20-25т", "Экскаватор 30-35т"]
        },
        {
          question: "Какое сечение свай (мм)?"
        },
        {
          question: "Глубина погружения (м)?"
        }
      ]
    },
    {
      ...
      questions: [
        {
          question: "На какой молот?"
        },
        {
          question: "Завод-изготовитель молота?"
        },
        {
          question: "Какое сечение свай (мм)?"
        }
    ...
    },
    {
      ...
      questions: [
        {
          question: "Сваескусыватель для квадратных или круглых свай?",
          options: ["Квадратные", "Круглые"]
        },
        {
          question: "Какое сечение свай (мм)?"
        }
    ...
    },
    {
      ...
      questions: [
        {
          question: "Диаметр сваи (мм)?"
        },
        {
          question: "Глубина забивания (м)?"
        }
      ]
    }
  ];
