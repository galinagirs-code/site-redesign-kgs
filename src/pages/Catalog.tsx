  ...
  const categories = [
    ...
    },
    {
      ...
      description: {
        ...
        sections: [
          ...
          {
            heading: "Шагающие сваебойные установки JuLi (серия KLB)",
            text: "Шагающие копровые установки JuLi серии KLB предназначены для выполнения свайных работ. Они могут оснащаться дизель-молотом, гидравлическим молотом, вибропогружателем или буровым станком (буровой головкой).\n\nГидравлические шагающие установки JULI серии KLB предназначены для выполнения свайных работ и лидерного бурения, они отличаются низким удельным давлением на грунт, высокой устойчивостью при выполнении работ на строительных площадках и многофункциональностью."
          },
          {
          ...
          {
            heading: "Преимущества установок JuLi KLB",
            list: [
    ...
    },
    {
      ...
      description: {
        ...
        sections: [
          ...
          {
            heading: "Горизонтальные буровые машины JuLi (серия JL)",
            text: "Горизонтально-направленные буровые установки JuLi серии JL широко используются для строительства железных дорог, дорог, укрепления рек, центра города, других ограниченных для строительства районов, для строительства водопроводов, угольного газа, электроники, телекоммуникаций, природного газа."
          },
          {
    ...
    },
    {
      ...
      description: {
        ...
        sections: [
          {
            heading: "Гидравлические экскаваторные вибропогружатели серия SG",
            text: "Гидравлический экскаваторный вибропогружатель серии SG — профессиональное оборудование с боковым зажимом для погружения и извлечения свайных элементов. Предназначен для монтажа на экскаваторы с грузоподъемностью от 18 до 40 тонн.\n\nПрименяется для погружения и извлечения шпунтовых свай, труб, двутавра, свай из бетона и железобетона, швеллера, уголков, арматуры, забивки деревянных свай, анкеров, а также уплотнения бетона."
          },
          {
            heading: "Преимущества серии SG (боковой зажим)",
            list: [
          ...
          {
            heading: "Гидравлические экскаваторные вибропогружатели серия VH",
            text: "Гидравлический экскаваторный вибропогружатель серии VH — профессиональное оборудование с нижним зажимом для погружения и извлечения свайных элементов. Предназначен для монтажа на экскаваторы различной грузоподъемности.\n\nНижний зажим обеспечивает особенно эффективную работу при погружении длинных свайных элементов и работе на объектах с ограниченной высотой."
          },
          {
            heading: "Преимущества серии VH (нижний зажим)",
            list: [
