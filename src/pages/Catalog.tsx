        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-6 text-muted-foreground text-base md:text-lg leading-relaxed mb-8">
              <p>
                Мы предлагаем комплексные решения для выполнения свайных работ — от подбора техники и оборудования до поставки запасных частей и полного технического сопровождения проектов.
              </p>
            </div>
