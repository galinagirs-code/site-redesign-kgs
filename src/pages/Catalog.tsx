    ...
    },
    {
      ...
      description: {
        ...
        sections: [
          ...
          {
            heading: "Сваебойные установки Dongtai Juli (серия KLB)",
            text: "Копровые установки Dongtai Juli серии KLB предназначены для выполнения свайных работ и лидерного бурения. Они могут оснащаться дизель-молотом, гидравлическим молотом, вибропогружателем или буровым станком (буровой головкой). Отличаются низким удельным давлением на грунт, высокой устойчивостью и многофункциональностью."
          },
          {
