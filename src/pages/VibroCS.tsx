...
import VibroCSHeroSection from "@/components/vibro-cs/VibroCSHeroSection";
import VibroCSVariantsSection from "@/components/vibro-cs/VibroCSVariantsSection";
import VibroCSBenefitsSection from "@/components/vibro-cs/VibroCSBenefitsSection";
import VibroCSDescriptionSection from "@/components/vibro-cs/VibroCSDescriptionSection";
import VibroCSGallerySection from "@/components/vibro-cs/VibroCSGallerySection";
...
const VibroCS = () => {
  const productSchema = {
    ...
    "description": "Гидравлические экскаваторные вибропогружатели серии CS с боковым зажимом для погружения шпунтовых свай, труб и свайных элементов. Модели CS350–CS500.",
    "brand": {
      "@type": "Brand",
      "name": "KGS"
    },
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Вибропогружатели экскаваторные серия CS | KGS"
        description="Гидравлические экскаваторные вибропогружатели с боковым зажимом серии CS. Модели CS350–CS500 для экскаваторов 18–45 т. Погружение шпунта, труб, свай."
        keywords="вибропогружатель экскаваторный, боковой зажим, серия CS, вибропогружатель на экскаватор, шпунт, погружение свай"
        canonical="https://kgs-ural.ru/catalog/vibro-cs"
        ogTitle="Вибропогружатели экскаваторные серия CS с боковым зажимом"
        ogDescription="Гидравлические вибропогружатели серии CS для экскаваторов 18–45 т. Модели CS350–CS500. Погружение шпунта, труб, металлических свай."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/vibro-cs" />
            </div>
          </div>
        </div>
      </header>
      ...
      <Breadcrumbs items={[
        ...
        { label: 'Вибропогружатели экскаваторные', path: '/catalog/vibropogružateli-ekskavatornye' },
        { label: 'Серия CS (боковой зажим)', path: '/catalog/vibro-cs' }
      ]} />

      <VibroCSHeroSection />
      <VibroCSVariantsSection />
      <VibroCSBenefitsSection />
      <VibroCSDescriptionSection />
      <VibroCSGallerySection />
