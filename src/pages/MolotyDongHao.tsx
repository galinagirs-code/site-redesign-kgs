...
const MolotyDongHao = () => {
  return (
    <div className="min-h-screen">
      <SEO 
        title="Молоты гидравлические DongHao | KGS"
        description="Молоты гидравлические DongHao для забивки свай"
        keywords="молоты донгхао, гидравлические молоты, молот для свай"
        canonical="https://kgs-ural.ru/catalog/moloty-donghao"
      />
      <ScrollToTop />
          ...
          <div className="container mx-auto px-4">
            <Breadcrumbs 
              items={[
                ...
                { label: "Молоты гидравлические DongHao" }
              ]}
            />
            ...
            <p className="text-xl text-white/90 max-w-3xl">
              Гидравлические сваебойные молоты для забивки свай
            </p>
          </div>
        </div>
