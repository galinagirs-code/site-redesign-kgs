...
import MachtyMkbeRuBenefits from "@/components/machty-mkbe-ru/MachtyMkbeRuBenefits";
  ...
  return (
    <div className="min-h-screen">
      ...
      <Breadcrumbs items={[
        ...
        { label: "Мачта копрово-бурильная экскаваторного типа (серия МКБЭ)", path: "/catalog/machty-mkbe-ru" },
      ]} />

      <MachtyMkbeRuHero />
      <MachtyMkbeRuSpecs />
      <MachtyMkbeRuBenefits />
