...
const YonganDZJ = () => {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Вибропогружатели электрические крановые Yongan (серия DZJ)",
    "description": "Электрические вибропогружатели Yongan серии DZJ для кранов. Экономичная альтернатива гидравлическим моделям с работой от электросети.",
    "brand": {
      "@type": "Brand",
      "name": "Yongan"
    },
    "category": "Вибропогружатели крановые",
    "manufacturer": {
      "@type": "Organization",
  ...
  const galleryImages = [
    "https://cdn.poehali.dev/files/6e7e7f2a-9b5e-4f52-8df0-0a93d45e6dd4.png",
    "https://cdn.poehali.dev/files/6e7e7f2a-9b5e-4f52-8df0-0a93d45e6dd4.png",
    "https://cdn.poehali.dev/files/6e7e7f2a-9b5e-4f52-8df0-0a93d45e6dd4.png",
    "https://cdn.poehali.dev/files/6e7e7f2a-9b5e-4f52-8df0-0a93d45e6dd4.png"
  ];
  ...
  const questions = [
    {
      question: "Какой вибропогружатель требуется?",
      options: ["Гидравлический YZ", "Гидравлический YZ-VM", "Электрический DZJ"]
    },
    {
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title="Вибропогружатели электрические крановые Yongan (серия DZJ) | KGS"
        description="Электрические вибропогружатели Yongan серии DZJ. Экономичность, простота эксплуатации, надежность конструкции. Работа от электросети."
        keywords="вибропогружатели, Yongan, серия DZJ, электрические вибропогружатели, крановые вибропогружатели"
        canonical="https://kgs-ural.ru/catalog/yongan-dzj"
        ogTitle="Вибропогружатели электрические крановые Yongan (серия DZJ)"
        ogDescription="Электрические вибропогружатели DZJ от Yongan. Экономичная альтернатива гидравлическим моделям."
      />
        ...
        <div className="container mx-auto px-4 py-8">
          <Breadcrumbs 
            items={[
              ...
              { label: "Вибропогружатели крановые", href: "/catalog#crane-vibro-drivers" },
              { label: "Вибропогружатели электрические крановые Yongan (серия DZJ)" }
            ]}
          />
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            <div>
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gray-100 mb-4">
                <OptimizedImage src={selectedImage || galleryImages[0]} alt="Вибропогружатели электрические крановые Yongan (серия DZJ)" className="w-full h-full object-contain" />
              </div>
            ...
            <div>
              <Badge className="mb-4">Вибропогружатели крановые</Badge>
              <h1 className="text-3xl font-bold mb-4">Вибропогружатели электрические крановые Yongan (серия DZJ)</h1>
              ...
              <div className="prose max-w-none mb-6">
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li className="flex items-start"><Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" /><span>Широкий спектр применения</span></li>
                  <li className="flex items-start"><Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" /><span>Эффективное использование на объектах с доступом к электроэнергии</span></li>
                </ul>
              </div>
          ...
          <Card className="mt-12">
            <CardContent className="p-8">
              ...
              <EquipmentForm equipmentType="Вибропогружатели электрические крановые Yongan (серия DZJ)" questions={questions} />
            </CardContent>
          </Card>
        </div>
      </main>
