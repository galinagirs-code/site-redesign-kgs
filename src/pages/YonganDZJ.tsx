...
const YonganDZJ = () => {
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Электрические крановые вибропогружатели Yongan серия DZJ",
    "description": "Электрические крановые вибропогружатели серии DZJ от Yongan. Более 30 лет опыта. Компоненты FAG, Siemens, Schneider Electric. До 60% дешевле гидравлических аналогов.",
    "brand": {
      "@type": "Brand",
      "name": "Yongan"
    },
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Электрические крановые вибропогружатели серии DZJ от Yongan. 14 моделей от 45 до 600 кВт. Компоненты FAG, Siemens. До 60% дешевле гидравлики."
        keywords="вибропогружатель электрический крановый, Yongan DZJ, серия DZJ, электрический вибропогружатель, погружение шпунта, сваи"
        canonical="https://kgs-ural.ru/catalog/yongan-dzj"
        ogTitle="Электрические крановые вибропогружатели Yongan серия DZJ"
        ogDescription="Вибропогружатели серии DZJ для крановых работ. Компоненты FAG, Siemens, Schneider Electric."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/yongan-dzj" />
            </div>
          </div>
        </div>
      </header>
      ...
      <Breadcrumbs items={[
        ...
        { label: 'Серия DZJ (Yongan)', path: '/catalog/yongan-dzj' }
      ]} />
