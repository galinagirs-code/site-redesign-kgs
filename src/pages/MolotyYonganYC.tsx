        ...
        <div className="container mx-auto px-4 py-8">
          <Breadcrumbs 
            items={[
              ...
              { label: "Молоты гидравлические Yongan (серия YC)" }
            ]}
          />
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold mb-4">Молоты гидравлические Yongan (серия YC)</h1>
              
              <div className="prose max-w-none mb-6">
                <h2 className="text-xl font-semibold mb-3">Гидравлические молоты Yongan (серия YC)</h2>
                ...
                <h3 className="text-lg font-semibold mb-3 mt-6">Преимущества молотов серии YC</h3>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Широкая сфера применения для забивки стальных трубчатых, железобетонных свай, шпунтов</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Простота управления и обслуживания</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Забивка свай без предварительного бурения даже в мерзлую почву</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Выносной пульт управления с автоматическим и ручным режимами работы</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Регулировка энергии удара</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Подключение к гидростанции или базовой машине</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Прочный материал амортизирующей подушки, кованая ударная часть</span>
                  </li>
                </ul>
              </div>
