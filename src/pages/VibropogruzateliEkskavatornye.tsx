              ...
              <Card className="border-primary/20">
                <CardContent className="p-8">
                  <h2 className="text-2xl font-bold text-primary mb-6">
                    Гидравлические экскаваторные вибропогружатели серия SG
                  </h2>
                  <p className="text-muted-foreground mb-6 leading-relaxed">
                    Гидравлический экскаваторный вибропогружатель серии SG — профессиональное оборудование с боковым зажимом для погружения и извлечения свайных элементов. Предназначен для монтажа на экскаваторы с грузоподъемностью от 18 до 40 тонн.
                  </p>
                  <p className="text-muted-foreground mb-6 leading-relaxed">
                  ...
                  <h3 className="text-xl font-semibold text-primary mb-4">
                    Преимущества серии SG (боковой зажим)
                  </h3>
