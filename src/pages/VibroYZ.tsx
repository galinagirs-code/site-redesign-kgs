...
import VibroYZHeroSection from "@/components/vibro-yz/VibroYZHeroSection";
...
const VibroYZ = () => {
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Гидравлические крановые вибропогружатели Yongan серия YZ",
    "description": "Гидравлические крановые вибропогружатели серии YZ от Yongan Machinery Co., Ltd. для погружения и извлечения шпунтовых свай, трубных свай и Н-балок. Морские и прибрежные работы.",
    "brand": {
      "@type": "Brand",
      "name": "Yongan"
    },
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Вибропогружатели крановые Yongan серия YZ | KGS"
        description="Гидравлические крановые вибропогружатели серии YZ от Yongan. Более 20 моделей от YZ-90D до YZ-800BX4. Погружение шпунта, труб, Н-балок. Морские работы."
        keywords="вибропогружатель крановый, Yongan YZ, гидравлический вибропогружатель, серия YZ, шпунт, погружение свай, морские работы"
        canonical="https://kgs-ural.ru/catalog/vibro-yz"
        ogTitle="Гидравлические крановые вибропогружатели Yongan серия YZ"
        ogDescription="Вибропогружатели серии YZ для крановых работ. Более 20 моделей от YZ-90D до YZ-800BX4. Компоненты Parker, FAG, Rexroth, Caterpillar."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/vibro-yz" />
            </div>
          </div>
        </div>
      </header>
      ...
      <Breadcrumbs items={[
        ...
        { label: 'Серия YZ (Yongan)', path: '/catalog/vibro-yz' }
      ]} />
