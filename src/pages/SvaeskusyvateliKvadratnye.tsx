...
const SvaeskusyvateliKvadratnye = () => {
  const productSchema = {
    ...
    "@type": "Product",
    name: "Сваескусыватели для квадратных свай",
    description: "Сваескусыватели для обрезки квадратных железобетонных свай 200x200 до 400x400 мм.",
  ...
  const specs = [
    { label: "Сечение свай", value: "200×200 — 400×400 мм" },
    { label: "Тип свай", value: "Квадратные ЖБ сваи" },
    { label: "Принцип работы", value: "Гидравлический захват" },
    { label: "Навеска", value: "На экскаватор" },
  ];

  return (
    <div className="min-h-screen">
      <SEO
        title="Сваескусыватели для квадратных свай | KGS"
        description="Сваескусыватели для квадратных свай 200x200-400x400 мм. Захват по четырем граням, чистый скол, сохранность арматуры."
        keywords="сваескусыватель для квадратных свай купить, обрезка железобетонных свай, скусыватель квадратных свай"
        canonical="https://kgs-ural.ru/catalog/svaeskusyvateli-kvadratnye"
        ogTitle="Сваескусыватели для квадратных свай"
        ogDescription="Сваескусыватели для квадратных свай 200x200-400x400 мм."
      />
      ...
      <section id="specs" className="py-10 md:py-14 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-heading font-bold text-primary mb-8 text-center">О сваескусывателях для квадратных свай</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              <div className="space-y-4">
                <p className="text-base text-primary leading-relaxed">
                  Сваескусыватели для квадратных свай — специализированное навесное оборудование для экскаваторов, предназначенное для обрезки верхней части квадратных железобетонных свай до проектной отметки.
                </p>
                <p className="text-base text-primary leading-relaxed">
                  Конструкция захватного механизма обеспечивает надёжную фиксацию квадратного сечения и точную обрезку по заданной отметке. Захват по четырём граням гарантирует чистый скол и сохранность арматуры.
                </p>
                <div className="space-y-2 pt-2">
                  {["Захват по четырём граням квадратного сечения", "Чистый скол без повреждения арматуры", "Сваи 200×200 — 400×400 мм", "Работа на любых грунтах и в любых условиях"].map((item) => (
