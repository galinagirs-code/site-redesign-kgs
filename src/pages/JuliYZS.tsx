...
const JuliYZS = () => {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Сваевдавливающая установка JULI (серия YZS)",
    "description": "Сваевдавливающая установка JULI серии YZS для статического вдавливания свай. Безударный метод погружения.",
    "brand": { "@type": "Brand", "name": "JULI" },
    "category": "Сваевдавливающие установки",
    "manufacturer": { "@type": "Organization", "name": "JULI" }
  };
  ...
  return (
    <div className="min-h-screen">
      <SEO title="Сваевдавливающая установка JULI (серия YZS) | KGS" description="Сваевдавливающая установка JULI серии YZS для статического вдавливания свай. Безударный метод погружения без вибрации и шума." keywords="сваевдавливающая установка купить, Juli YZS, статическое вдавливание свай" canonical="https://kgs-ural.ru/catalog/juli-yzs" ogTitle="Сваевдавливающая установка JULI (серия YZS)" ogDescription="Установка JULI YZS для статического вдавливания свай. Безударная технология." />
      ...
      <main className="pt-16">
        <div className="container mx-auto px-4 py-8">
          <Breadcrumbs items={[{ label: "Главная", href: "/" }, { label: "Каталог", href: "/catalog" }, { label: "Сваевдавливающие установки", href: "/catalog#pile-pressing" }, { label: "Сваевдавливающая установка JULI (серия YZS)" }]} />

          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            <div>
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gray-100 mb-4"><OptimizedImage src={selectedImage || galleryImages[0]} alt="Сваевдавливающая установка JULI (серия YZS)" className="w-full h-full object-contain" /></div>
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold mb-4">Сваевдавливающая установка JULI (серия YZS)</h1>
              
              <div className="prose max-w-none mb-6">
                <p className="text-gray-600 mb-4">Сваевдавливающая установка JULI серии YZS предназначена для статического вдавливания свай в грунт. Безударный метод погружения обеспечивает минимальные вибрации и шум, что особенно важно при работе в городских условиях и вблизи существующих зданий.</p>
                <p className="text-gray-600 mb-4">Для получения подробной информации о характеристиках, стоимости и сроках поставки, пожалуйста, свяжитесь с нашими специалистами.</p>
              </div>
          ...
          <Card className="mt-12"><CardContent className="p-8"><h2 className="text-2xl font-bold mb-6">Получить консультацию</h2><EquipmentForm equipmentType="Сваевдавливающая установка JULI (серия YZS)" questions={questions} /></CardContent></Card>
        </div>
      </main>
