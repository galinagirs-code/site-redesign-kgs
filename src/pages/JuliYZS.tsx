          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            ...
            <div>
              ...
              <div className="prose max-w-none mb-6">
                <p className="text-gray-600 mb-4">Сваевдавливающая установка Dongtai Juli серии YZS предназначена для статического вдавливания свай в грунт. Безударный метод погружения обеспечивает минимальные вибрации и шум, что особенно важно при работе в городских условиях и вблизи существующих зданий.</p>
