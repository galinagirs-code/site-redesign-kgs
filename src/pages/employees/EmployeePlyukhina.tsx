...
const EmployeePlyukhina = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Юлия Александровна Плюхина — Менеджер по продажам КГС"
        description="Контакты Юлии Александровны Плюхиной, Менеджера по продажам ООО КГС. Телефон, email, мессенджеры."
        canonical="https://kgs-ural.ru/contact/plyukhina"
      />
      <ScrollToTop />
      ...
      <Breadcrumbs items={[
        ...
        { label: "Юлия Александровна Плюхина", path: "/contact/plyukhina" }
      ]} />
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center animate-fade-in">
            ...
            <h1 className="text-3xl md:text-4xl font-heading font-bold text-white mb-3">
              Юлия Александровна Плюхина
            </h1>
            <p className="text-accent text-lg font-medium">Менеджер по продажам ООО «КГС»</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-xl">
          <Card className="p-8 space-y-5">
            <a
              href="mailto:sales2@kgs-ural.ru"
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium text-primary">sales2@kgs-ural.ru</p>
              </div>
            </a>

            <a
              href="tel:+79630371728"
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-muted transition-colors group"
            >
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 transition-colors">
              ...
              <div>
                ...
                <p className="font-medium text-primary">+7 963 037 17 28</p>
              </div>
            </a>

            <a
              href="https://web.telegram.org/k/#@JuliaKGS"
              target="_blank"
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium text-[#2AABEE]">@JuliaKGS</p>
              </div>
            </a>

            <a
              href="https://max.ru/u/f9LHodD0cOJmyHDuRGSnU3RvFQhNRXsryVhRkTb0be0IzFK-EKoqA_wgHTw"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-muted transition-colors group"
            >
