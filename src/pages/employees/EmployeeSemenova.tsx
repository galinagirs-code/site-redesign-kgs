...
const EmployeeSemenova = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Анна Викторовна Семенова — Менеджер по продажам КГС"
        description="Контакты Анны Викторовны Семеновой, Менеджера по продажам ООО КГС. Телефон, email, мессенджеры."
        canonical="https://kgs-ural.ru/contact/semenova"
      />
      <ScrollToTop />
      ...
      <Breadcrumbs items={[
        ...
        { label: "Анна Викторовна Семенова", path: "/contact/semenova" }
      ]} />
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-xl">
          <Card className="p-8 space-y-5">
            <a
              href="mailto:sales4@kgs-ural.ru"
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium text-primary">sales4@kgs-ural.ru</p>
              </div>
            </a>

            <a
              href="tel:+79097033066"
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-muted transition-colors group"
            >
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 transition-colors">
              ...
              <div>
                ...
                <p className="font-medium text-primary">+7 909 703 30 66</p>
              </div>
            </a>

            <a
              href="https://web.telegram.org/k/#8300876014"
              target="_blank"
            ...
            <a
              href="https://web.max.ru/249116775"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-muted transition-colors group"
            >
