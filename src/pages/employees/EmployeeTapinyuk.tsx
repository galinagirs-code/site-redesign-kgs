...
const EmployeeTapinyuk = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Ольга Александровна Тапинюк — Исполнительный директор КГС"
        description="Контакты Ольги Александровны Тапинюк, Исполнительного директора ООО КГС. Телефон, email, мессенджеры."
        canonical="https://kgs-ural.ru/contact/tapinyuk"
      />
      <ScrollToTop />
      ...
      <Breadcrumbs items={[
        ...
        { label: "Ольга Александровна Тапинюк", path: "/contact/tapinyuk" }
      ]} />
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center animate-fade-in">
            ...
            <h1 className="text-3xl md:text-4xl font-heading font-bold text-white mb-3">
              Ольга Александровна Тапинюк
            </h1>
            <p className="text-accent text-lg font-medium">Исполнительный директор ООО «КГС»</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 max-w-xl">
          <Card className="p-8 space-y-5">
            <a
              href="mailto:zhirova@kgs-ural.ru"
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium text-primary">zhirova@kgs-ural.ru</p>
              </div>
            </a>

            <a
              href="tel:+79655270238"
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-muted transition-colors group"
            >
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 transition-colors">
              ...
              <div>
                ...
                <p className="font-medium text-primary">+7 965 527 02 38</p>
              </div>
            </a>

            <a
              href="https://web.telegram.org/k/#6727158803"
              target="_blank"
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium text-[#2AABEE]">Написать в Telegram</p>
              </div>
            </a>

            <a
              href="https://web.max.ru/28568206"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-muted transition-colors group"
            >
