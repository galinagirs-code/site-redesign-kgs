...
const EmployeeMutallapov = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Артур Фирдависович Муталлапов — Сервисный инженер КГС"
        description="Контакты Артура Фирдависовича Муталлапова, Сервисного инженера ООО КГС. Телефон, email, мессенджеры."
        canonical="https://kgs-ural.ru/contact/mutallapov"
      />
      <ScrollToTop />
      ...
      <Breadcrumbs items={[
        ...
        { label: "Артур Фирдависович Муталлапов", path: "/contact/mutallapov" }
      ]} />
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center animate-fade-in">
            ...
            <h1 className="text-3xl md:text-4xl font-heading font-bold text-white mb-3">
              Артур Фирдависович Муталлапов
            </h1>
            <p className="text-accent text-lg font-medium">Сервисный инженер ООО «КГС»</p>
          </div>
        </div>
      </section>
          ...
          <Card className="p-8 space-y-5">
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium text-primary">service@kgs-ural.ru</p>
              </div>
            </a>

            <a
              href="tel:+79630378244"
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-muted transition-colors group"
            >
              <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 transition-colors">
              ...
              <div>
                ...
                <p className="font-medium text-primary">+7 963 037 82 44</p>
              </div>
            </a>

            <a
              href="https://web.telegram.org/k/#@KoperGroupService"
              target="_blank"
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium text-[#2AABEE]">@KoperGroupService</p>
              </div>
            </a>

            <a
              href="https://web.max.ru/40033047"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-4 p-4 rounded-xl hover:bg-muted transition-colors group"
            >
