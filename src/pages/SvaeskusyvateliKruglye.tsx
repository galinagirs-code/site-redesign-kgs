...
import KruglyeHeroSection from "@/components/svaeskusyvateli-kruglye/KruglyeHeroSection";
import KruglyeVariantsSection from "@/components/svaeskusyvateli-kruglye/KruglyeVariantsSection";
import KruglyeDescriptionSection from "@/components/svaeskusyvateli-kruglye/KruglyeDescriptionSection";
import KruglyeGallerySection from "@/components/svaeskusyvateli-kruglye/KruglyeGallerySection";
...
const SvaeskusyvateliKruglye = () => {
  return (
    <div className="min-h-screen">
      ...
      <KruglyeHeroSection />
      <KruglyeVariantsSection />
      <KruglyeDescriptionSection />
      <KruglyeGallerySection />
