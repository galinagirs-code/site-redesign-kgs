...
const SvaeskusyvateliKruglye = () => {
  const productSchema = {
    ...
    description: "Сваескусыватели для обрезки круглых железобетонных свай диаметром 200-800 мм.",
  ...
  const specs = [
    { label: "Диаметр свай", value: "200 — 800 мм" },
    { label: "Тип свай", value: "Круглые ЖБ сваи" },
  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Сваескусыватели для круглых свай 200-800 мм. Специализированная форма захвата, равномерное распределение усилия, высокая точность обрезки."
        keywords="сваескусыватель для круглых свай купить, обрезка свай, скусыватель круглых свай"
        canonical="https://kgs-ural.ru/catalog/svaeskusyvateli-kruglye"
        ogTitle="Сваескусыватели для круглых свай"
        ogDescription="Сваескусыватели для круглых свай 200-800 мм."
      />
