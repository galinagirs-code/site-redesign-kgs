            ...
            <div>
              ...
              <div className="prose max-w-none mb-6">
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li className="flex items-start"><Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" /><span>Эффективное распределение вибрационной нагрузки</span></li>
                  <li className="flex items-start"><Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" /><span>Универсальность применения</span></li>
                </ul>
              </div>
