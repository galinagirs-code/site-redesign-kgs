...
const YonganYZ = () => {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Вибропогружатели гидравлические крановые Yongan (серия YZ)",
    "description": "Гидравлические вибропогружатели Yongan серии YZ для кранов. Регулируемый дебаланс, переменная частота 0-2500 об/мин, более 30 моделей.",
    "brand": {
      "@type": "Brand",
      "name": "Yongan"
    },
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title="Вибропогружатели гидравлические крановые Yongan (серия YZ) | KGS"
        description="Гидравлические вибропогружатели Yongan серии YZ для кранов. Регулируемый дебаланс, переменная частота, высокая универсальность. Более 30 моделей."
        keywords="вибропогружатели, Yongan, серия YZ, гидравлические вибропогружатели, крановые вибропогружатели, шпунтовые работы"
        canonical="https://kgs-ural.ru/catalog/yongan-yz"
        ogTitle="Вибропогружатели гидравлические крановые Yongan (серия YZ)"
        ogDescription="Вибропогружатели YZ от Yongan. Для погружения шпунтовых свай, труб, двутавра, железобетонных свай."
      />
        ...
        <div className="container mx-auto px-4 py-8">
          <Breadcrumbs 
            items={[
              ...
              { label: "Вибропогружатели гидравлические крановые Yongan (серия YZ)" }
            ]}
          />
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            <div>
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gray-100 mb-4">
                <OptimizedImage
                  ...
                  alt="Вибропогружатели гидравлические крановые Yongan (серия YZ)"
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold mb-4">Вибропогружатели гидравлические крановые Yongan (серия YZ)</h1>
              ...
              <div className="prose max-w-none mb-6">
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Переменная частота: изменяя расход масла, мотор может изменять скорость для достижения переменной частоты вибрации в нужном диапазоне 0 — 2500 об/мин</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Высокая универсальность: широкий спектр применения для различных строительных условий</span>
                  </li>
                </ul>
              </div>
          ...
          <Card className="mt-12">
            <CardContent className="p-8">
              ...
              <EquipmentForm 
                equipmentType="Вибропогружатели гидравлические крановые Yongan (серия YZ)"
                questions={questions}
              />
            </CardContent>
          </Card>
