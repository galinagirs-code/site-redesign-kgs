...
import UdlinennayaStrelaHeroSection from "@/components/udlinennaya-strela/UdlinennayaStrelaHeroSection";
import UdlinennayaStrelaVariantsSection from "@/components/udlinennaya-strela/UdlinennayaStrelaVariantsSection";
import UdlinennayaStrelaDescriptionSection from "@/components/udlinennaya-strela/UdlinennayaStrelaDescriptionSection";
import UdlinennayaStrelaGallerySection from "@/components/udlinennaya-strela/UdlinennayaStrelaGallerySection";

const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Удлинённая стрела для экскаватора",
  description: "Удлинённая стрела для увеличения рабочего радиуса и зоны выполнения работ. Изготавливается под конкретную модель экскаватора. Длина 10–22 м, вылет до 20 м.",
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/udlinennaya-strela" />
            </div>
          </div>
        </div>
      </header>
      ...
      <Breadcrumbs items={[
        ...
        { label: "Удлинённая стрела для экскаватора", path: "/catalog/udlinennaya-strela" },
      ]} />

      <UdlinennayaStrelaHeroSection />
      <UdlinennayaStrelaVariantsSection />
      <UdlinennayaStrelaDescriptionSection />
      <UdlinennayaStrelaGallerySection />
