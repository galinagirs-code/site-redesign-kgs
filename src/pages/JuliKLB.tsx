            ...
            <div>
              ...
              <div className="prose max-w-none mb-6">
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Механизм позиционирования мачты с гидравлическим приводом</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Механизм передвижения шагающего типа с гидравлическим приводом (обеспечивает низкое удельное давление на грунт)</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Гидравлическая система с дизельным приводом</span>
                  </li>
                </ul>
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Мобильность — шагающий механизм передвижения</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Низкое удельное давление на грунт</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Высокая устойчивость при работе</span>
                  </li>
                  <li className="flex items-start">
                    <Icon name="check" className="w-5 h-5 text-primary mr-2 mt-0.5 flex-shrink-0" />
                    <span>Автономность работы</span>
                  </li>
                </ul>
              </div>
