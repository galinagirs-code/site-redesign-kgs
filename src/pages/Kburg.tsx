...
const Kburg = () => {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Сваебойная установка КБУРГ",
    "description": "Сваебойная установка КБУРГ для забивки свай. Профессиональное оборудование для свайных работ.",
    "brand": {
      "@type": "Brand",
      "name": "КБУРГ"
    },
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title="Сваебойная установка КБУРГ | KGS"
        description="Сваебойная установка КБУРГ для забивки свай. Надежное оборудование для свайных работ любой сложности."
        ...
        ogTitle="Сваебойная установка КБУРГ - профессиональное оборудование"
        ogDescription="Сваебойная установка КБУРГ для выполнения свайных работ. Консультация и подбор оборудования."
      />
        ...
        <div className="container mx-auto px-4 py-8">
          <Breadcrumbs 
            items={[
              ...
              { label: "Сваебойная установка КБУРГ" }
            ]}
          />
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            <div>
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gray-100 mb-4">
                <OptimizedImage
                  ...
                  alt="Сваебойная установка КБУРГ"
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold mb-4">Сваебойная установка КБУРГ</h1>
              
              <div className="prose max-w-none mb-6">
                <p className="text-gray-600 mb-4">
                  Сваебойная установка КБУРГ предназначена для выполнения свайных работ любой сложности. Надежное и производительное оборудование для профессионального использования.
                </p>
                <p className="text-gray-600 mb-4">
          ...
          <Card className="mt-12">
            <CardContent className="p-8">
              ...
              <EquipmentForm 
                equipmentType="Сваебойная установка КБУРГ"
                questions={questions}
              />
            </CardContent>
          </Card>
