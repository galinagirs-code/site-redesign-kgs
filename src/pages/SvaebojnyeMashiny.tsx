            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card className="border-primary/20">
                <CardContent className="p-8">
                  ...
                  <p className="text-primary mb-4 leading-relaxed">
                    Копровые установки Dongtai Juli серии KLB предназначены для выполнения свайных работ. Они могут оснащаться дизель-молотом, гидравлическим молотом, вибропогружателем или буровой установкой (вращатель).
                  </p>
                  <p className="text-primary mb-6 leading-relaxed">
