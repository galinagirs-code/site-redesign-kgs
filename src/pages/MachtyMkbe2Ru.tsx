...
const MachtyMkbe2Ru = () => {
  const productSchema = {
    ...
    "@type": "Product",
    name: "Мачта копрово-бурильная на экскаваторе серия МКБЭ-2",
    description: "Мачта МКБЭ-2 — первая российская разработка с двумя рядами направляющих для молота и вращателя. Забивка свай до 12 м, бурение до 17 м.",
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Мачта копрово-бурильная на экскаваторе МКБЭ-2 (Россия) | KGS"
        description="Мачта МКБЭ-2 для экскаваторов 20–45 т. Молот и вращатель на одной мачте. Забивка свай до 12 м, бурение до 17 м. Первая российская разработка."
        keywords="мачта МКБЭ-2, копрово-бурильная мачта на экскаваторе, МКБЭ-2 купить, навесное оборудование экскаватор, два ряда направляющих"
        canonical="https://kgs-ural.ru/catalog/machty-mkbe2-ru"
        ogTitle="Мачта МКБЭ-2 — копрово-бурильная на экскаваторе (Россия)"
        ogDescription="Первая российская мачта с молотом и вращателем на одной конструкции. Экскаватор 20–45 т. Забивка до 12 м, бурение до 17 м."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/machty-mkbe2-ru" />
            </div>
          </div>
        </div>
      </header>
