...
const Svaeskusyvateli = () => {
  ...
  const productSchema = {
    ...
    "@type": "Product",
    "name": "Сваескусыватели",
    "description": "Сваескусыватели для круглых и квадратных свай - навесное оборудование для экскаваторов для обрезки железобетонных свай до проектной отметки.",
    "brand": {
      "@type": "Brand",
      "name": "KGS"
    },
  ...
  const photoGallery = [
    "https://cdn.poehali.dev/files/placeholder-cutter-1.jpg",
    "https://cdn.poehali.dev/files/placeholder-cutter-2.jpg",
    "https://cdn.poehali.dev/files/placeholder-cutter-3.jpg",
    "https://cdn.poehali.dev/files/placeholder-cutter-4.jpg"
  ];

  return (
    <div className="min-h-screen">
      <SEO 
        title="Сваескусыватели для круглых и квадратных свай | KGS"
        description="Сваескусыватели - навесное оборудование для экскаваторов для обрезки железобетонных свай. Высокая производительность, точность, безопасность."
        keywords="сваескусыватели, обрезка свай, скусыватель свай, навесное для экскаватора, обрезка железобетона"
        canonical="https://kgs-ural.ru/catalog/cutters"
        ogTitle="Сваескусыватели - эффективная обрезка свай до проектной отметки"
        ogDescription="Сваескусыватели для круглых и квадратных свай. Быстро, точно, безопасно. Экономия времени в 10 раз по сравнению с ручной обрезкой."
      />
        ...
        <div className="bg-gradient-to-br from-primary via-primary/95 to-secondary py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl text-white/90 max-w-3xl">
              Специализированное навесное оборудование для обрезки железобетонных свай до проектной отметки
            </p>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card className="border-primary/20">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-semibold text-primary mb-4">
                    Преимущества для квадратных свай
                  </h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <Icon name="check-circle" className="h-5 w-5 text-accent mr-3 mt-0.5 flex-shrink-0" />
              ...
              <Card className="border-primary/20">
                <CardContent className="p-8">
                  <h2 className="text-2xl font-bold text-primary mb-6">
                    Общие преимущества сваескусывателей
                  </h2>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {photoGallery.map((photo, index) => (
                      ...
                      >
                        <OptimizedImage
                          src={photo}
                          alt={`Сваескусыватели - фото ${index + 1}`}
                          width={400}
                          height={300}
              ...
              <Card className="border-primary/20">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <Icon name="check-circle" className="h-5 w-5 text-accent mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Сваескусыватели для круглых свай</span>
                    </li>
                    <li className="flex items-start">
                      <Icon name="check-circle" className="h-5 w-5 text-accent mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Сваескусыватели для квадратных свай</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
...
export default Svaeskusyvateli;
