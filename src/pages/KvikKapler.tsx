...
import KvikKaplerHeroSection from "@/components/kvik-kapler/KvikKaplerHeroSection";
import KvikKaplerVariantsSection from "@/components/kvik-kapler/KvikKaplerVariantsSection";
import KvikKaplerDescriptionSection from "@/components/kvik-kapler/KvikKaplerDescriptionSection";
import KvikKaplerGallerySection from "@/components/kvik-kapler/KvikKaplerGallerySection";

const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Быстросъёмное соединение (квик-каплер)",
  description: "Быстросъёмное соединение для оперативной замены навесного оборудования экскаватора без выхода оператора из кабины. Типы P и H, класс экскаватора 1,5–52 т.",
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/kvik-kapler" />
            </div>
          </div>
        </div>
      </header>
      ...
      <Breadcrumbs items={[
        ...
        { label: "Быстросъёмное соединение (квик-каплер)", path: "/catalog/kvik-kapler" },
      ]} />

      <KvikKaplerHeroSection />
      <KvikKaplerVariantsSection />
      <KvikKaplerDescriptionSection />
      <KvikKaplerGallerySection />
