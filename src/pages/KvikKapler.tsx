...
const KvikKapler = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO title="Быстросъёмное соединение (квик-каплер) | KGS" description="Квик-каплер для оперативной замены навесного оборудования экскаватора. Сокращает время переоснащения и повышает эффективность." keywords="квик каплер купить, быстросъемное соединение экскаватор, quick coupler" canonical="https://kgs-ural.ru/catalog/kvik-kapler" ogTitle="Быстросъёмное соединение (квик-каплер) для экскаватора" ogDescription="Квик-каплер для быстрой замены навесного оборудования без дополнительных инструментов." />
      ...
      <main className="pt-16">
        <div className="container mx-auto px-4 py-8">
          <Breadcrumbs items={[{ label: "Главная", href: "/" }, { label: "Каталог", href: "/catalog" }, { label: "Вибропогружатели экскаваторные", href: "/catalog#excavator-vibro-drivers" }, { label: "Быстросъёмное соединение (квик-каплер)" }]} />

          <div className="grid lg:grid-cols-2 gap-8 mt-8">
            <div>
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gray-100 mb-4"><OptimizedImage src={selectedImage || galleryImages[0]} alt="Быстросъёмное соединение (квик-каплер)" className="w-full h-full object-contain" /></div>
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold mb-4">Быстросъёмное соединение (квик-каплер)</h1>
              
              <div className="prose max-w-none mb-6">
                <h2 className="text-xl font-semibold mb-3">Быстросъёмное соединение (квик-каплер)</h2>
                <p className="text-gray-600 mb-4">Быстросъёмное соединение (квик-каплер) обеспечивает возможность оперативной замены навесного оборудования без дополнительных инструментов. Существенно сокращает время переоснащения экскаватора и повышает эффективность работы на объекте.</p>
              </div>
          ...
          <Card className="mt-12"><CardContent className="p-8"><h2 className="text-2xl font-bold mb-6">Получить консультацию</h2><EquipmentForm equipmentType="Быстросъёмное соединение (квик-каплер)" questions={questions} /></CardContent></Card>
        </div>
      </main>
