...
import VibroSHeroSection from "@/components/vibro-s/VibroSHeroSection";
import VibroSVariantsSection from "@/components/vibro-s/VibroSVariantsSection";
import VibroSBenefitsSection from "@/components/vibro-s/VibroSBenefitsSection";
import VibroSDescriptionSection from "@/components/vibro-s/VibroSDescriptionSection";
import VibroSGallerySection from "@/components/vibro-s/VibroSGallerySection";
...
const VibroS = () => {
  const productSchema = {
    ...
    "description": "Гидравлические экскаваторные вибропогружатели серии S с нижним зажимом для погружения шпунтовых свай, труб и свайных элементов. Модели S250–S1100.",
    "brand": {
      "@type": "Brand",
      "name": "KGS"
    },
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Вибропогружатели экскаваторные серия S | KGS"
        description="Гидравлические экскаваторные вибропогружатели с нижним зажимом серии S. Модели S250–S1100 для экскаваторов 15–90 т. Погружение шпунта, труб, свай."
        keywords="вибропогружатель экскаваторный, нижний зажим, серия S, вибропогружатель на экскаватор, шпунт, погружение свай"
        canonical="https://kgs-ural.ru/catalog/vibro-s"
        ogTitle="Вибропогружатели экскаваторные серия S с нижним зажимом"
        ogDescription="Гидравлические вибропогружатели серии S для экскаваторов 15–90 т. Модели S250–S1100. Погружение шпунта, труб, металлических свай."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/vibro-s" />
            </div>
          </div>
        </div>
      </header>
      ...
      <Breadcrumbs items={[
        ...
        { label: 'Серия S (нижний зажим)', path: '/catalog/vibro-s' }
      ]} />

      <VibroSHeroSection />
      <VibroSVariantsSection />
      <VibroSBenefitsSection />
      <VibroSDescriptionSection />
      <VibroSGallerySection />
