...
const MachtyMkbe = () => {
  const productSchema = {
    ...
    "@type": "Product",
    name: "Мачты копровые экскаваторные (серия МКБЭ)",
    description: "Мачты МКБЭ и МКБЭ-2 — навесное копрово-бурильное оборудование на гусеничный экскаватор. Забивка свай, лидерное бурение. Российское производство.",
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Мачты копровые экскаваторные серия МКБЭ | KGS"
        description="Мачты МКБЭ и МКБЭ-2 для экскаваторов от 20 т. Забивка свай до 12 м, бурение до 24 м, диаметр до 800 мм. Российское производство. Декларация ЕАЭС."
        keywords="мачты МКБЭ, копрово-бурильная мачта, мачта на экскаватор, МКБЭ-2, навесное оборудование экскаватор, забивка свай экскаватор, бурение свай"
        canonical="https://kgs-ural.ru/catalog/machty-mkbe"
        ogTitle="Мачты копровые экскаваторные МКБЭ и МКБЭ-2 — российское производство"
        ogDescription="Навесное копрово-бурильное оборудование на экскаватор. МКБЭ: бурение до 24 м. МКБЭ-2: одновременно молот и вращатель на одной мачте."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <MobileMenu currentPath="/catalog/machty-mkbe" />
            </div>
          </div>
        </div>
      </header>
      ...
      <Breadcrumbs items={[
        ...
        { label: "Мачты копровые экскаваторные (серия МКБЭ)", path: "/catalog/machty-mkbe" },
      ]} />
